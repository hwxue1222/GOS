...
function seedContractsTemplatesV48(db: Db) {
  ...
  const tpl: ContractTemplate = {
    ...
    placeholders: [
      ...
      { key: 'partyA_address', label: 'Address（联系地址）', required: true },
      { key: 'partyA_contact', label: 'Contact Number（联系电话）', required: true },
...
<html>
  ...
  const professionalTpl: ContractTemplate = {
    ...
    placeholders: [
      ...
      { key: 'partyA_address', label: 'Party A address（甲方地址）', required: true },
      { key: 'partyA_contact', label: 'Party A contact number（甲方电话）', required: true },
